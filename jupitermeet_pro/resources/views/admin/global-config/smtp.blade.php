            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <select class="form-control{{ $errors->has('MAIL_ENCRYPTION') ? ' is-invalid' : '' }}"
                        ...
                        <option value="ssl" @if (getSetting('MAIL_ENCRYPTION') == 'ssl') selected @endif>{{ __('SSL') }}
                        </option>
                        <option value="tls" @if (getSetting('MAIL_ENCRYPTION') == 'tls') selected @endif>{{ __('TLS') }}
                        </option>
                        <option value="starttls" @if (getSetting('MAIL_ENCRYPTION') == 'starttls') selected @endif>{{ __('STARTTLS') }}
                        </option>
                    </select>
