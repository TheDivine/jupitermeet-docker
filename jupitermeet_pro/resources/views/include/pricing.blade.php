                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="mb-2">
                                <div class="row py-2">
                                    <div class="col">
                                        <span
                                            class="@if (!$plan->features->chatgpt) no-feature @endif">{{ __('AI Chatbot') }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="row py-2">
                                    <div class="col">
                                        <span> {{ $plan->features->video_quality }} {{ __('Video Quality') }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="row py-2">
                                    <div class="col">
                                        {!! '<b>' .
                                            ($plan->features->time_limit == -1 ? __('Unlimited') : __('Up to') . $plan->features->time_limit) .
                                            '</b>' .
                                            __('minutes') !!}
                                    </div>
                                </div>
                            ...
                            <div class="mb-2">
                                <div class="row py-2">
                                    <div class="col">
                                        {!! '<b>' .
                                            ($plan->features->meeting_no == -1 ? __('Unlimited') : $plan->features->meeting_no) .
                                            '</b> ' .
                                            __('Meetings') !!}
                                    </div>
                                </div>
                            ...
                            <div class="mb-2">
                                <div class="row py-2">
                                    <div class="col">
                                        {!! '<b>' .
                                            ($plan->features->user_limit == -1 ? __('Unlimited') : $plan->features->user_limit) .
                                            '</b> ' .
                                            __('Users') !!}
                                    </div>
                                </div>
