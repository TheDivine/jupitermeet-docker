...
Route::post('meeting-files', [App\Http\Controllers\DashboardController::class, 'fileUploads']);
Route::post('delete-meeting-files', [App\Http\Controllers\DashboardController::class, 'deleteFolder']);
