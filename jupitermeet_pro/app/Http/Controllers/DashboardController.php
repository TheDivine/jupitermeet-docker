...
class DashboardController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('auth', ['except' => ['meeting', 'checkMeeting', 'checkMeetingPassword', 'getDetails', 'setLocale', 'widget', 'checkDetails', 'fileUploads', 'deleteFolder']]);
    ...
    public function fileUploads(Request $request)
    {
        ...
        try {
            ...
            $folderPath = 'public/file_uploads/' . $meetingId;
